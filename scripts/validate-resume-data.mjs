#!/usr/bin/env node
// Validates that the resume data (src/data/resume.ts + src/data/contacts.ts)
// has the structure the rest of the pipeline (Astro page, PDF/DOCX
// generators) expects. Cheap to run, catches empty/missing fields that
// would otherwise only surface as broken-looking output.
