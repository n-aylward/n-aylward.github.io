// Canonical, single-sourced resume content.
//
// This file is the ONE place to edit resume content. Both the live
// webpage (src/pages/index.astro) and the generated downloads
// (scripts/generate-resume-pdf.mjs, scripts/generate-resume-docx.mjs)
// render from this same data, so the page and the downloadable
// PDF/DOCX can never drift out of sync with each other again.
...
export interface ResumeCompany {
  ...
  dateRange: string;
  /**
   * One entry for a single-role stint, multiple entries for a company
   * where the person was promoted through several titles over time.
   */
  roles: ResumeRole[];
}
...
export const RESUME = {
  ...
  experience: [
      ...
      roles: [
        {
          ...
          bullets: [
            ...
            "Produced DataRobot's public-facing Workload API documentation (tutorial, CLI reference, and install guide), translating internal engineering documentation into user-facing content.",
            "Prototyped an internal automation that drafts release notes directly from merged pull requests.",
            ...
            "Redesigned the search taxonomy's facet detection to track a major documentation restructuring across NextGen, Developer, REST API, Python client, Reference, Agentic AI, and Workload API docs, and closed indexing gaps that had been dropping tabbed UI content and duplicating LLM sidecar files out of search results.",
            "Cut search-QA cycle time by adding a lightweight way to run the search UI against live Algolia indexes with a read-only key, so filter and ranking changes could be verified without a full documentation rebuild.",
            ...
            "Extended the documentation site's machine-readable documentation exports, including a markdown sidecar file for every page, and fixed markdown-link handling for LLM and agentic consumers of the site.",
      ...
      roles: [
        {
          ...
          dateRange: "January 2021 – November 2021",
          bullets: [
            "Worked in an Agile product team during a fast-paced transitional period, producing documentation in two-week sprints and participating in standups to track progress.",
            "Built Pendo guides, walk-throughs, banners, and toasts to assist users within our product and facilitate the transition to a new user interface.",
            ...
            "Contributed to our HTML table sort and filter implementation in MadCap Flare, creating custom CSS classes to import use-case-specific DataTables functions by topic.",
            "Expanded our in-product changelogs for SAP Security Note support and proprietary Onapsis roles.",
            "Created a customer-facing guide for our most difficult third-party deployment, walking the user through the creation and configuration of a Microsoft Azure VM for the Onapsis Platform.",
          ],
        },
      ],
    },
    {
      ...
      roles: [
        {
          title: "Technical Writer and Team Lead",
          ...
          bullets: [
            ...
            "Worked with company leadership and product owners to identify and address documentation needs across our range of school information software.",
        ...
        },
        {
          ...
          bullets: [
            ...
            "Improved the search engine optimization of our documentation site using Google Search Console.",
          ],
        },
        {
