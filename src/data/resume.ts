      ...
      roles: [
        {
          ...
          bullets: [
            ...
            "Redesigned the search taxonomy's facet detection to track a major documentation restructuring across NextGen, Developer, REST API, Python client, Reference, Agentic AI, and Workload API docs, closed indexing gaps that had been dropping tabbed content and duplicating LLM sidecar files, and cut search-QA cycle time with a way to verify filter and ranking changes against live indexes without a full rebuild.",
